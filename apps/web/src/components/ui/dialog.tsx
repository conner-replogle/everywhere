  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "fixed top-[18%] left-1/2 z-50 grid w-[calc(100%-2rem)] max-w-md -translate-x-1/2 gap-4 rounded-lg border bg-popover p-5 text-popover-foreground shadow-2xl shadow-black/50 duration-150",
      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            className="absolute top-3.5 right-3.5 rounded-sm p-0.5 text-muted-foreground opacity-70 transition-opacity hover:opacity-100 focus-visible:ring-2 focus-visible:ring-ring/60 focus-visible:outline-none"
            aria-label="Close"
          >
